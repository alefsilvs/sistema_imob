...
class EncryptedCharField(models.CharField):
    ...
    def __init__(self, *args, **kwargs):
        if 'max_length' in kwargs:
            requested_max_length = kwargs['max_length']

            if requested_max_length in (510, 4000):
                adjusted_max_length = requested_max_length
            elif requested_max_length == 1000:
                adjusted_max_length = 4000
            elif requested_max_length <= 255:
                adjusted_max_length = 510
            else:
                adjusted_max_length = max(requested_max_length * 2, 510)

            kwargs['max_length'] = adjusted_max_length
        else:
            kwargs['max_length'] = 510
